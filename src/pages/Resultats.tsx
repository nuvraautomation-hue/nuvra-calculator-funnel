  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground relative overflow-hidden">
      ...
      <section className="px-6 py-12 max-w-lg mx-auto text-center">
        <motion.div {...fadeUp()}>
          <img src={nuvraLogo} alt="Nuvra" className="w-14 h-14 object-contain mx-auto mb-4 opacity-80" />
      ...
      <section className="px-6 py-12 max-w-lg mx-auto text-center">
        ...
        <motion.div {...fadeUp(0.15)} className="rounded-xl border border-border bg-card overflow-hidden mb-6">
          <iframe
